    ...
    do {
        ...
        when {
            ...
            entry.contains(Regex("\\(.*\\)")) -> {
                ...
                val mapSign = mutableMapOf<String, BigInteger>("+" to BigInteger("1"), "-" to BigInteger("1"), "*" to BigInteger("2"), "/" to BigInteger("2"), "^" to BigInteger("3"))
                                ...
                                when (postfix[i]) {
                                    "+" -> {
                                        if (postfix[i - 2].contains(Regex("\\d+")) && postfix[i - 1].contains(Regex("\\d+"))) {
                                            ...
                                            numero = (postfix[i - 2].toBigInteger() + map[postfix[i - 1]]!!)

                                        } else if (postfix[i - 1].contains(Regex("\\d+"))) {
                                            numero = map[postfix[i - 2]]!! + postfix[i - 1].toBigInteger()
                                            ...
                                            numero = map[postfix[i - 2]]!! + map[postfix[i - 1]]!!
                                        }
                        ...
                        listA[k].contains("-") && !listA[k].contains(Regex("\\d")) -> {
                            ...
                            if (n % 2 == 0) {
                                ...
                                if (listA[k+1].contains(Regex("\\d+"))) {
                                    ...
                                    num -= "map[listA[k+1]]!!".toBigInteger()
                                    continue
                                }
